...
int ll_remove(LinkedList* this,int index)
{
	...
	if( this!=NULL && index>=0 && index<ll_len(this))
	{
		...
		{
			actual = (getNode(this, index-1)->pNextNode);
...
*/
    if(this!=NULL && from>=0 && from<ll_len(this) && from<to && to<=ll_len(this))
    {
    	...
    	if(cloneArray!=NULL)
    	{
			...
			{
				//printf("COPIA: cloneArray dir: %d\n", cloneArray);
				ll_add(cloneArray, ll_get(this, i));
			}
    	}
    }
	//printf("\nFINAL: cloneArray dir: %d\n", cloneArray);
...
int ll_sort(LinkedList* this, int (*pFunc)(void* ,void*), int order)
{
    ...
    if(this!=NULL && pFunc!=NULL && (order==0 || order==1))
    {
    	do
    	{
    		...
    		{
    			if(order==1 && pFunc(getNode(this, i)->pElement,getNode(this, i+1)->pElement)==1)
    			{
    				flagSwap=1;
					elementAux = getNode(this, i)->pElement;
					getNode(this, i)->pElement = getNode(this, i+1)->pElement;
					getNode(this, i+1)->pElement = elementAux;

    			}
    			else if(order==0 && pFunc(getNode(this, i)->pElement,getNode(this, i+1)->pElement)==-1)
    			{
    				flagSwap=1;
					elementAux = getNode(this, i)->pElement;
					getNode(this, i)->pElement = getNode(this, i+1)->pElement;
...
/**
 * \brief Filtra los elementos de una lista según una condición
 *
 * \param this Lista a evaluar
 * \param pFunc Funcion que devuelve 1 si la cumple la condicion y 0 si no
 * \return
 */
